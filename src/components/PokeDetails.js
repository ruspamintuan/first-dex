  ...
  return (
    <div style={{ width: "90%" }}>
      ...
      <div className="div-bordered">
        <div>Description</div>
        {Object.keys(flavorTexts).length > 0 && descriptionKey && <div>{flavorTexts[descriptionKey] ? flavorTexts[descriptionKey] : "Data Unavailable"}</div>}
      </div>
      <div className="div-bordered">
        <div>Abilities</div>
      ...
      <div className="div-bordered" style={{ height: "48vh", overflowY: "scroll" }}>
        {evoChain.basic && (
          <>
